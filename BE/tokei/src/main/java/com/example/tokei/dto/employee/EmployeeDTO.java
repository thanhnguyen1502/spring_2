package com.example.tokei.dto.employee;
...
public class EmployeeDTO implements Validator {
    ...
    public EmployeeDTO(Integer idEmployee, Boolean gender, LocalDate dateOfBirth, double salary, String image, String nameEmployee, String address, String phoneNumtokeir, String email, Position position, Account account) {
        ...
        this.phoneNumtokeir = phoneNumtokeir;
        this.email = email;
    ...
    public String getPhoneNumtokeir() {
        return phoneNumtokeir;
    }

    public void setPhoneNumtokeir(String phoneNumtokeir) {
        this.phoneNumtokeir = phoneNumtokeir;
    }
